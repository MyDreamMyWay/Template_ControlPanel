    ...
    <script src="__CP__/js/morris-0.4.3.min.js"></script>
    <script src="__CP__/js/morris/chart-data-morris.js"></script>
    <script src="__CP__/js/tablesorter/jquery.tablesorter.js"></script>
    <script src="__CP__/js/tablesorter/tables.js"></script>
    <!--[if lte IE 8]><script src="js/excanvas.min.js"></script><![endif]-->
	<script src="__CP__/js/flot/jquery.flot.js"></script>
	<script src="__CP__/js/flot/jquery.flot.tooltip.min.js"></script>
	<script src="__CP__/js/flot/jquery.flot.resize.js"></script>
	<script src="__CP__/js/flot/jquery.flot.pie.js"></script>
	<script src="__CP__/js/flot/chart-data-flot.js"></script>
